...
class ActorClient:
    ...
    def handle(self, msg):
        ...
        # === Hooks for player logic
            ...
            series_player_id = [p[1] for p in player_id_map if p[0] == unique_player_id]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--host", help="Server host hostess", default=DEFAULT_HOST)
    parser.add_argument(
        "--api-port", help="Server API host port", default=DEFAULT_API_PORT
    )
    parser.add_argument("--cert", help="Server ssl certificate", default=DEFAULT_CERT)
    parser.add_argument(
    ...
    parser_rt.add_argument("--temp-token", help="Temporary token received from email")
